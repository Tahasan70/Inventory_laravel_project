    ...
    <nav class="navbar sticky-top shadow-sm navbar-expand-lg navbar-light py-2">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="header01">
                ...
                <div><a class="btn mt-3 bg-gradient-primary" href="<?php echo e(url('/userLogin')); ?>">Start Sale</a></div>
            </div>
        </div>
    </nav>
            ...
            <div class="container pt-2">
                <div class="row align-items-center mb-5">
                    <div class="col-12 col-md-10 col-lg-5 mb-5 mb-lg-0">
                        ...
                        <div class="d-flex flex-wrap"><a class="btn bg-gradient-primary me-2 mb-2 mb-sm-0" href="<?php echo e(url('/userLogin')); ?>">Start Sale</a>
                            <a class="btn bg-gradient-primary mb-2 mb-sm-0" href="<?php echo e(url('/userLogin')); ?>">Login</a></div>
                    </div>
                ...
                <div class="row">
                    <div class="col-12 col-md-6 col-lg-3 p-3">
                        <div class="card px-0 text-center">
                            <img class=" card-img-top mb-3 w-100" src="<?php echo e(asset('/images/man.jpg')); ?>" alt="">
                            <h5>Danny Bailey</h5>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laravel_project_ostad\M16_Project\Inventory\resources\views/pages/home.blade.php ENDPATH**/ ?>